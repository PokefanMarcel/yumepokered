...
VermilionCity_TextPointers:
	...
	dw_const VermilionCityCooltrainerMText,       TEXT_VERMILIONCITY_COOLTRAINER_M ; marcelnote - new
...
VermilionCityCooltrainerMText: ; marcelnote - new
	text_far _VermilionCityCooltrainerMText
	text_end
