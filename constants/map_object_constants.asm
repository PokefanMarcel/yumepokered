...
DEF WARP_DIR_SHIFT EQU 5
DEF WARP_DIR_MASK  EQU %111 << WARP_DIR_SHIFT    ; %11100000
DEF WARP_ID_MASK   EQU ~(%111 << WARP_DIR_SHIFT) ; %00011111
DEF WARP_DOWN  EQU $01
DEF WARP_UP    EQU $02
DEF WARP_LEFT  EQU $03
DEF WARP_RIGHT EQU $04

DEF BOULDER_MOVEMENT_BYTE_2 EQU $10

; marcelnote - dungeon warp IDs (see data/maps/special_warps.asm)
	const_def
	const DUNGEON_WARP_SEAFOAM_1F_LEFT
	const DUNGEON_WARP_SEAFOAM_1F_RIGHT
	const DUNGEON_WARP_SEAFOAM_B1F_LEFT
	const DUNGEON_WARP_SEAFOAM_B1F_RIGHT
	const DUNGEON_WARP_SEAFOAM_B2F_LEFT
	const DUNGEON_WARP_SEAFOAM_B2F_RIGHT
	const DUNGEON_WARP_SEAFOAM_B3F_LEFT
	const DUNGEON_WARP_SEAFOAM_B3F_RIGHT
	const DUNGEON_WARP_VICTORY_ROAD_3F
	const DUNGEON_WARP_POKEMON_MANSION_3F_LEFT
	const DUNGEON_WARP_POKEMON_MANSION_3F_MIDDLE
	const DUNGEON_WARP_POKEMON_MANSION_3F_RIGHT
	const DUNGEON_WARP_CINNABAR_VOLCANO_1F
DEF NUM_DUNGEON_WARPS EQU const_value
