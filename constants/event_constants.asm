...
; Cinnabar Island events
	const_next $278
	const EVENT_POKEMON_MANSION_SWITCH_ON
	const_skip 16
	const EVENT_BEAT_POKEMON_MANSION_1F_TRAINER_0
	const_skip 14
	...
	const EVENT_CINNABAR_GYM_GATE3_UNLOCKED ; marcelnote - gates 2-6 reindexed as 3-7
	const EVENT_CINNABAR_GYM_GATE4_UNLOCKED
	const EVENT_CINNABAR_GYM_GATE5_UNLOCKED
	const EVENT_CINNABAR_GYM_GATE6_UNLOCKED
	const EVENT_CINNABAR_GYM_GATE7_UNLOCKED
	const_skip 39 ; marcelnote - adjusted down from 40 for new EVENT_CINNABAR_GYM_GATE2_UNLOCKED
	...
	const EVENT_CINNABAR_VOLCANO_2F_BOULDER2_ON_SWITCH
	const_skip 4
	const EVENT_BEAT_CINNABAR_VOLCANO_B1F_TRAINER_0
	const EVENT_BEAT_CINNABAR_VOLCANO_B1F_TRAINER_1
	const EVENT_BEAT_CINNABAR_VOLCANO_B1F_TRAINER_2
	const EVENT_BEAT_CINNABAR_VOLCANO_1F_TRAINER_0
...
; Saffron City events
	...
	const_skip 1 ; marcelnote - adjusted
...
; Route 1 events
	...
	const EVENT_BEAT_ROUTE_1_OAK ; marcelnote - postgame Oak battle
...
; Route 10 events
	...
	const_skip 2
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_0
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_1
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_2
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_3
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_4
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_5
	const EVENT_BEAT_ROCK_TUNNEL_1F_TRAINER_6
	const_skip
	const EVENT_BEAT_POWER_PLANT_VOLTORB_0 ; Voltorb1
	const EVENT_BEAT_POWER_PLANT_VOLTORB_1 ; Voltorb2
	const EVENT_BEAT_POWER_PLANT_VOLTORB_2 ; Voltorb3
	const EVENT_BEAT_POWER_PLANT_VOLTORB_3 ; Electrode1
	const EVENT_BEAT_POWER_PLANT_VOLTORB_4 ; Voltorb4
	const EVENT_BEAT_POWER_PLANT_VOLTORB_5 ; Voltorb5
	const EVENT_BEAT_POWER_PLANT_VOLTORB_6 ; Electrode2
	const EVENT_BEAT_POWER_PLANT_VOLTORB_7 ; Voltorb6
...
; Route 12 events
	...
	const EVENT_GOT_FISHING_GUIDE       ; marcelnote - new
	const_skip 4
...
; Route 23 events
	...
	const_skip
	const EVENT_VICTORY_ROAD_2F_BOULDER_ON_SWITCH1
	const EVENT_BEAT_VICTORY_ROAD_2F_TRAINER_0
	const EVENT_BEAT_VICTORY_ROAD_2F_TRAINER_1
	const EVENT_BEAT_VICTORY_ROAD_2F_TRAINER_2
	const EVENT_BEAT_VICTORY_ROAD_2F_TRAINER_3
	const EVENT_BEAT_VICTORY_ROAD_2F_TRAINER_4
	;const EVENT_BEAT_MOLTRES                      ; marcelnote - removed Moltres from Victory Road
	const EVENT_VICTORY_ROAD_2F_BOULDER_ON_SWITCH2
	const EVENT_VICTORY_ROAD_2F_GOT_HITMON ; marcelnote - new

; Route 24 events
	const_next $540
	const EVENT_GOT_NUGGET
	const EVENT_BEAT_ROUTE_24_ROCKET ; never read
	...
	; marcelnote - removed redundant EVENT_NUGGET_REWARD_AVAILABLE
...
; Mt. Moon events
	const_next $570
	const_skip
	const EVENT_BEAT_MT_MOON_1F_TRAINER_0
	const EVENT_BEAT_MT_MOON_1F_TRAINER_1
	const EVENT_BEAT_MT_MOON_1F_TRAINER_2
	const EVENT_BEAT_MT_MOON_1F_TRAINER_3
	const EVENT_BEAT_MT_MOON_1F_TRAINER_4
	const EVENT_BEAT_MT_MOON_1F_TRAINER_5
	const EVENT_BEAT_MT_MOON_1F_TRAINER_6
	const_skip
	const EVENT_BEAT_MT_MOON_EXIT_SUPER_NERD
	const EVENT_BEAT_MT_MOON_B2F_TRAINER_0
	const EVENT_BEAT_MT_MOON_B2F_TRAINER_1
	const EVENT_BEAT_MT_MOON_B2F_TRAINER_2
	const EVENT_BEAT_MT_MOON_B2F_TRAINER_3
...
; S.S. Anne events
	const_next $5C0
	const_skip 4
	const EVENT_BEAT_SS_ANNE_BOW_TRAINER_0
	const EVENT_BEAT_SS_ANNE_BOW_TRAINER_1
	...
	const EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_0
	const EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_1
	const EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_2
	const EVENT_BEAT_SS_ANNE_1F_ROOMS_TRAINER_3
	const_skip 4 ; marcelnote - minus 8
	const EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_0
	const EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_1
	const EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_2
	const EVENT_BEAT_SS_ANNE_2F_ROOMS_TRAINER_3
	const_skip 4 ; marcelnote - minus 8
	const EVENT_BEAT_SS_ANNE_B1F_TRAINER_0
	const EVENT_BEAT_SS_ANNE_B1F_TRAINER_1
	const EVENT_BEAT_SS_ANNE_B1F_TRAINER_2
	const EVENT_BEAT_SS_ANNE_B1F_TRAINER_3
...
; Victory Road 3F events
	const_next $660
	const EVENT_VICTORY_ROAD_3F_BOULDER_ON_SWITCH1
	const EVENT_BEAT_VICTORY_ROAD_3F_TRAINER_0
	const EVENT_BEAT_VICTORY_ROAD_3F_TRAINER_1
	const EVENT_BEAT_VICTORY_ROAD_3F_TRAINER_2
	const EVENT_BEAT_VICTORY_ROAD_3F_TRAINER_3
	const_skip
	const EVENT_VICTORY_ROAD_3F_BOULDER_ON_SWITCH2

; Rocket Hideout events
	const_next $670
	const_skip
	const EVENT_BEAT_ROCKET_HIDEOUT_B1F_TRAINER_0
	const EVENT_BEAT_ROCKET_HIDEOUT_B1F_TRAINER_1
	const EVENT_BEAT_ROCKET_HIDEOUT_B1F_TRAINER_2
	const EVENT_BEAT_ROCKET_HIDEOUT_B1F_TRAINER_3
	const EVENT_BEAT_ROCKET_HIDEOUT_B1F_TRAINER_4
	const_skip
	const EVENT_ROCKET_HIDEOUT_B1F_DOOR_UNLOCKED ; marcelnote - renamed from EVENT_ENTERED_ROCKET_HIDEOUT
	const_skip 7
	const EVENT_67F ; ???
	const_skip
	const EVENT_BEAT_ROCKET_HIDEOUT_B2F_TRAINER_0
	const_skip 15
	const EVENT_BEAT_ROCKET_HIDEOUT_B3F_TRAINER_0
	const EVENT_BEAT_ROCKET_HIDEOUT_B3F_TRAINER_1
	const_skip 15
	const EVENT_BEAT_ROCKET_HIDEOUT_B4F_TRAINER_0
	const EVENT_BEAT_ROCKET_HIDEOUT_B4F_TRAINER_1
	const EVENT_BEAT_ROCKET_HIDEOUT_B4F_TRAINER_2
	const EVENT_ROCKET_HIDEOUT_B4F_DOOR_UNLOCKED
...
; Silph Co. events
	...
	const EVENT_GOT_LAPRAS ; marcelnote - new
	const_skip 2 ; decreased by 1
...
; Pokémon Mansion events
	const_next $800
	const_skip
	const EVENT_BEAT_POKEMON_MANSION_2F_TRAINER_0
	const_skip 15
	const EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_0
	const EVENT_BEAT_POKEMON_MANSION_3F_TRAINER_1
	const_skip 14
	const EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_0
	const EVENT_BEAT_POKEMON_MANSION_B1F_TRAINER_1
...
; Victory Road 1F events
	const_next $910
	const_skip
	const EVENT_BEAT_VICTORY_ROAD_1F_TRAINER_0
	const EVENT_BEAT_VICTORY_ROAD_1F_TRAINER_1
	const_skip 4
	const EVENT_VICTORY_ROAD_1F_BOULDER_ON_SWITCH
...
; Silph Factory events ; marcelnote - new
	const_next $930
	const_skip
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_0
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_1
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_2
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_3
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_4
	const EVENT_BEAT_SILPH_FACTORY_1F_TRAINER_5
	const EVENT_SILPH_FACTORY_1F_UNLOCKED_DOOR1
	const_skip
	const EVENT_BEAT_SILPH_FACTORY_2F_TRAINER_0
...
; Rock Tunnel events
	const_next $9B0
	const_skip
	const EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_0
	const EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_1
	const EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_2
	const EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_3
	const EVENT_BEAT_ROCK_TUNNEL_B1F_TRAINER_4
