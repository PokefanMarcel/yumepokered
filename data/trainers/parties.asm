...
; Cerulean City ; marcelnote - modified
	; original
	;db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, SQUIRTLE, 0
	;db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, BULBASAUR, 0
	;db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, CHARMANDER, 0
	; new
	db $FF, 18, PIDGEOTTO, 15, SANDSHREW, 15, BELLSPROUT, 17, SQUIRTLE, 0
	db $FF, 18, PIDGEOTTO, 15, SANDSHREW, 15, VULPIX, 17, BULBASAUR, 0
	db $FF, 18, PIDGEOTTO, 15, SANDSHREW, 15, KRABBY, 17, CHARMANDER, 0

Rival2Data: ; marcelnote - modified
; SS Anne 2F
	; original
	...
	; new
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, PINSIR, 20, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, PINSIR, 20, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, PINSIR, 20, CHARMELEON, 0
; Pokémon Tower 2F
	; original
	...
	; new
	db $FF, 24, SANDSLASH, 23, GROWLITHE, 22, MACHOP, 21, KADABRA, 25, WARTORTLE, 0
	db $FF, 24, SANDSLASH, 23, GYARADOS, 22, MACHOP, 21, KADABRA, 25, IVYSAUR, 0
	db $FF, 24, SANDSLASH, 23, EXEGGCUTE, 22, MACHOP, 21, KADABRA, 25, CHARMELEON, 0
; Silph Co. 7F
	; original
	...
	; new
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, VICTREEBEL, 37, MACHOKE, 41, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, NINETALES, 37, MACHOKE, 41, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, KINGLER, 37, MACHOKE, 41, CHARIZARD, 0
; Route 22
	; original
	...
	; new
	db $FF, 47, PIDGEOT, 45, PINSIR, 45, ARCANINE, 47, VICTREEBEL, 50, ALAKAZAM, 53, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 45, PINSIR, 45, GYARADOS, 47, NINETALES, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, PINSIR, 45, EXEGGUTOR, 47, KINGLER, 50, ALAKAZAM, 53, CHARIZARD, 0
