...
PalPacket_PikachusBeachHiscore: PAL_SET PAL_SURFING_HISCORE, 0, 0, 0
PalPacket_SurfingRaichu:         PAL_SET PAL_SURFING_RAICHU, PAL_SURFING_RAICHU, PAL_SURFING_RAICHU, PAL_SURFING_RAICHU
