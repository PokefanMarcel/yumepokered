...
ENDC
	...
	; pokeyellow Surfing Pikachu reference palettes:
;	PAL_PIKACHUS_BEACH       RGB 31,31,30, 31,30,22, 23,27,31, 06,06,06
;	PAL_PIKACHU_PORTRAIT     RGB 31,31,30, 28,23,09, 18,14,10, 06,06,06
;	PAL_PIKACHUS_BEACH_TITLE RGB 31,31,30, 16,16,16, 31,25,09, 06,06,06
	; pokeyellow CGB reference:
;	PAL_PIKACHUS_BEACH       RGB 31,31,31, 31,31,00, 11,23,31, 03,03,03
;	PAL_PIKACHU_PORTRAIT     RGB 31,31,31, 31,18,00, 19,07,01, 03,03,03
;	PAL_PIKACHUS_BEACH_TITLE RGB 31,31,31, 09,09,09, 31,21,00, 03,03,03
