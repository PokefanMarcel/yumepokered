MapSongBanks::
	...
	db MUSIC_INDIGO_PLATEAU, 0 ; ROUTE_28 ; marcelnote - new location
	db MUSIC_ROUTES3, 0        ; ORANGE_ROUTE_1 ; marcelnote - new location
	; Indoor maps
	db MUSIC_PALLET_TOWN, 0      ; REDS_YELLOWS_HOUSES ; marcelnote - was REDS_HOUSE_1F
	db MUSIC_PALLET_TOWN, 0      ; BLUES_HOUSE
	db MUSIC_OAKS_LAB, 0         ; OAKS_LAB
	db MUSIC_POKECENTER, 0       ; VIRIDIAN_POKECENTER_MART ; marcelnote - merged Viridian Pokecenter and Mart
	...
	db MUSIC_POKECENTER, 0       ; PEWTER_POKECENTER_MART ; marcelnote - merged Pewter Pokecenter and Mart
	db MUSIC_CITIES1, 0          ; PEWTER_MUSEUM ; marcelnote - merged Pewter Museum floors
	db MUSIC_CITIES1, 0          ; PEWTER_NIDORAN_HOUSE
	db MUSIC_CITIES1, 0          ; PEWTER_SPEECH_HOUSE
	db MUSIC_GYM, 0              ; PEWTER_GYM
	db MUSIC_CITIES1, 0          ; CELADON_GROVE_NORTH_GATE  ; marcelnote - new location
	...
	db MUSIC_ROUTES3, 0          ; MT_MOON_SQUARE ; marcelnote - new location
	db MUSIC_POKECENTER, 0       ; CERULEAN_POKECENTER_MART  ; marcelnote - merged Cerulean Pokecenter and Mart
	db MUSIC_CITIES2, 0          ; CERULEAN_TRASHED_HOUSE
	db MUSIC_CITIES2, 0          ; CERULEAN_TRADE_HOUSE
	db MUSIC_CITIES2, 0          ; CERULEAN_BADGE_HOUSE ; marcelnote - changed from MUSIC_CITIES1
	...
	db MUSIC_POKECENTER, 0       ; VERMILION_POKECENTER_MART ; marcelnote - merged Vermilion Pokecenter and Mart
	db MUSIC_CITIES2, 0          ; VERMILION_GOOD_ROD_HOUSE ; marcelnote - from Old to Good Rod
	...
	db MUSIC_SS_ANNE, 0          ; SS_ANNE_B1F ; marcelnote - merged SS Anne B1F and B1FRooms
	...
	db MUSIC_VERMILION, 0        ; ROUTE_11_GATE            ; marcelnote - merged ROUTE_11_GATE floors
	...
	db MUSIC_POKECENTER, 0       ; LAVENDER_POKECENTER_MART ; marcelnote - merged Lavender Pokecenter and Mart
	...
	db MUSIC_CITIES1, 0          ; ROUTE_12_GATE                ; marcelnote - merged ROUTE_12_GATE floors
	db MUSIC_CITIES2, 0          ; ROUTE_12_FISHING_GUIDE_HOUSE ; marcelnote - from Super Rod to Fishing Guide, chanegd from MUSIC_CELADON
	db MUSIC_POKECENTER, 0       ; CELADON_POKECENTER
	db MUSIC_POKECENTER, 0       ; CELADON_MART_1F2F3F          ; marcelnote - merged 1F 2F 3F
	db MUSIC_POKECENTER, 0       ; CELADON_MART_4F5F6F          ; marcelnote - merged 4F 5F + new 6F
	db MUSIC_POKECENTER, 0       ; CELADON_MART_ROOF
	db MUSIC_POKECENTER, 0       ; CELADON_MART_ELEVATOR
	db MUSIC_CELADON, 0          ; CELADON_MANSION              ; marcelnote - merged Celadon Mansion floors, added 4F
	...
	db MUSIC_CELADON, 0          ; CELADON_GROVE_SOUTH_GATE     ; marcelnote - was ROUTE_16_GATE_2F
	...
	db MUSIC_DUNGEON3, 0         ; CELADON_GROVE                ; marcelnote - new location
	db MUSIC_CITIES1, 0          ; ROUTE_15_GATE                ; marcelnote - merged ROUTE_15_GATE floors
	db MUSIC_CITIES1, 0          ; ROUTE_16_GATE                ; marcelnote - merged ROUTE_16_GATE floors
	db MUSIC_CELADON, 0          ; ROUTE_16_FLY_HOUSE
	db MUSIC_CITIES1, 0          ; ROUTE_18_GATE                ; marcelnote - merged ROUTE_18_GATE floors
	db MUSIC_POKECENTER, 0       ; SAFFRON_POKECENTER_MART      ; marcelnote - merged Saffron Pokecenter and Mart
	db MUSIC_CITIES1, 0          ; COPYCATS_HOUSE               ; marcelnote - merged Copycat's house floors
	...
	db MUSIC_CITIES1, 0          ; POKEMON_ACADEMY_1F2F ; marcelnote - new location
	db MUSIC_CITIES1, 0          ; POKEMON_ACADEMY_3F4F ; marcelnote - new location
	...
	db MUSIC_POKECENTER, 0       ; FUCHSIA_POKECENTER_MART ; marcelnote - merged Fuchsia Pokecenter and Mart
	db MUSIC_CITIES2, 0          ; FUCHSIA_BILLS_GRANDPAS_HOUSE
	db MUSIC_CITIES2, 0          ; WARDENS_HOUSE
	db MUSIC_CITIES2, 0          ; FUCHSIA_MEETING_ROOM
	db MUSIC_CITIES2, 0          ; FUCHSIA_SUPER_ROD_HOUSE    ; marcelnote - from Good to Super Rod
	db MUSIC_CITIES2, 0          ; FUCHSIA_MOVE_DELETER_HOUSE ; marcelnote - new location
	...
	db MUSIC_POKECENTER, 0       ; CINNABAR_POKECENTER_MART   ; marcelnote - merged Cinnabar Pokecenter and Mart
	db MUSIC_CINNABAR, 0         ; CINNABAR_LAB               ; marcelnote - merged Cinnabar Lab maps
