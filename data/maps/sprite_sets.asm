...
MapSpriteSets:
	...
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_17 ; marcelnote - was SPRITESET_CYCLING_ROAD
...
SplitMapSpriteSets:
	...
	db EAST_WEST,   60, SPRITESET_PALLET_VIRIDIAN, SPRITESET_CELADON         ; SPLITSET_ROUTE_16 ; marcelnote - modified for new map dimensions, was SPRITESET_CYCLING_ROAD
	db EAST_WEST,   34, SPRITESET_PALLET_VIRIDIAN, SPRITESET_FUCHSIA         ; SPLITSET_ROUTE_18 ; marcelnote - was SPRITESET_CYCLING_ROAD
...
; SPRITESET_PALLET_VIRIDIAN
	...
	db SPRITE_GAMBLER
	db SPRITE_BIKER ; marcelnote - replaced SPRITE_SEEL
	db SPRITE_OAK
	db SPRITE_SWIMMER
	db SPRITE_POKE_BALL
...
; SPRITESET_VERMILION
	...
	db SPRITE_GAMBLER
	db SPRITE_MONSTER
	db SPRITE_GUARD ; marceltnote - unused? (removed in pokeyellow)
	db SPRITE_SAILOR
	db SPRITE_COOLTRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_POKE_BALL
...
; SPRITESET_INDIGO ; marcelnote - only for ROUTE 23 (Guards) and INDIGO PLATEAU so mostly useless
	db SPRITE_YOUNGSTER
	db SPRITE_GYM_GUIDE
	db SPRITE_MONSTER
	db SPRITE_BLUE
...
; SPRITESET_SAFFRON
	...
	db SPRITE_ROCKER
	db SPRITE_COOLTRAINER_M
	db SPRITE_MONSTER ; marcelnote - unused? (removed in pokeyellow)
	db SPRITE_POKE_BALL
	db SPRITE_GAMBLER_ASLEEP
...
; SPRITESET_CYCLING_ROAD ; marcelnote - most seem unused (also used on split sets)
	db SPRITE_BIKER
	db SPRITE_COOLTRAINER_M
	db SPRITE_SILPH_WORKER_M
	db SPRITE_FISHER
...
; SPRITESET_MANDARIN ; marcelnote - new spriteset
	...
	db SPRITE_GAMBLER_ASLEEP ; unused
