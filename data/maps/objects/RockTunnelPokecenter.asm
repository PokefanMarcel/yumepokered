	...
	const_export ROCKTUNNELPOKECENTER_BENCH_GUY ; marcelnote - BenchGuy has a sprite
...
RockTunnelPokecenter_Object:
	...
	object_event  7,  5, SPRITE_FISHER, STAY, NONE, TEXT_ROCKTUNNELPOKECENTER_FISHER
	object_event  8,  2, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_ROCKTUNNELPOKECENTER_LINK_RECEPTIONIST
	object_event  0,  5, SPRITE_BENCH_GUY, STAY, RIGHT, TEXT_ROCKTUNNELPOKECENTER_BENCH_GUY ; marcelnote - BenchGuy has a sprite
