	...
	const_export ROCKTUNNEL1F_BLACKBELT ; marcelnote - added Blackbelt
...
RockTunnel1F_Object:
	...
	object_event 26, 17, SPRITE_BLACKBELT, STAY, DOWN, TEXT_ROCKTUNNEL1F_BLACKBELT ; marcelnote - added Blackbelt
