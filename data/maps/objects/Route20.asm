...
Route20_Object:
	...
	def_warp_events
	warp_event 48,  5, ANY_DIR, SEAFOAM_ISLANDS_1F, 1
	warp_event 58,  9, ANY_DIR, SEAFOAM_ISLANDS_1F, 3
	...
	def_object_events
	object_event 84,  8, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER1, OPP_SWIMMER, 9 ; marcelnote - adjusted position from x=87
	...
	object_event 84, 13, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER6, OPP_SWIMMER, 11 ; marcelnote - adjusted position from x=87
