...
PokemonAcademy3F4F_Object:
	...
	bg_event 31,  3, TEXT_POKEMONACADEMY4F_SIGN
	...
	object_event 24,  7, SPRITE_GAMEBOY_KID, STAY, DOWN, TEXT_POKEMONACADEMY4F_GAMEBOY_KID1
	object_event 25,  7, SPRITE_GAMEBOY_KID, STAY, DOWN, TEXT_POKEMONACADEMY4F_GAMEBOY_KID2
	object_event 28,  4, SPRITE_GRANNY, STAY, UP, TEXT_POKEMONACADEMY4F_GRANNY
