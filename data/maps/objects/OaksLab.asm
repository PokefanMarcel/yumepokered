	...
	const_export OAKSLAB_OAK_WALKING
...
OaksLab_Object:
	...
	def_warp_events
	warp_event  4, 11, WARP_DOWN, LAST_MAP, 3
	warp_event  5, 11, WARP_DOWN, LAST_MAP, 3
	...
	object_event  5, 10, SPRITE_OAK, STAY, UP, TEXT_OAKSLAB_OAK_WALKING
