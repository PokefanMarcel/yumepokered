...
ViridianPokecenterMart_Object:
	...
	object_event  7,  5, SPRITE_GENTLEMAN, STAY, NONE, TEXT_VIRIDIANPOKECENTER_GENTLEMAN
	object_event  2,  3, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_VIRIDIANPOKECENTER_COOLTRAINER_M
