	...
	const_export VIRIDIANGYM_BLACKBELT1
	const_export VIRIDIANGYM_ROCKER1
	const_export VIRIDIANGYM_BLACKBELT2
	const_export VIRIDIANGYM_COOLTRAINER_M2
	const_export VIRIDIANGYM_BLACKBELT3
...
ViridianGym_Object:
	...
	def_warp_events
	warp_event 16, 17, WARP_DOWN, LAST_MAP, 5
	warp_event 17, 17, WARP_DOWN, LAST_MAP, 5
	...
	object_event 11, 11, SPRITE_BLACKBELT, STAY, UP, TEXT_VIRIDIANGYM_BLACKBELT1, OPP_BLACKBELT, 6
	object_event 10,  7, SPRITE_ROCKER, STAY, DOWN, TEXT_VIRIDIANGYM_ROCKER1, OPP_TAMER, 3
	object_event  3,  7, SPRITE_BLACKBELT, STAY, LEFT, TEXT_VIRIDIANGYM_BLACKBELT2, OPP_BLACKBELT, 7
	object_event 13,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_VIRIDIANGYM_COOLTRAINER_M2, OPP_COOLTRAINER_M, 10
	object_event 10,  1, SPRITE_BLACKBELT, STAY, DOWN, TEXT_VIRIDIANGYM_BLACKBELT3, OPP_BLACKBELT, 8
