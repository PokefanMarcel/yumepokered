...
SilphCo4F_Object:
	...
	def_warp_events
	warp_event 24,  0, ANY_DIR, SILPH_CO_3F, 2
	warp_event 26,  0, ANY_DIR, SILPH_CO_5F, 2
	warp_event 20,  0, ANY_DIR, SILPH_CO_ELEVATOR, 1
	warp_event 11,  7, ANY_DIR, SILPH_CO_10F, 4
	warp_event 17,  3, ANY_DIR, SILPH_CO_6F, 4
	warp_event  3, 15, ANY_DIR, SILPH_CO_10F, 5
	warp_event 17, 11, ANY_DIR, SILPH_CO_10F, 6
