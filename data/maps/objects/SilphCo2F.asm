...
SilphCo2F_Object:
	...
	def_warp_events
	warp_event 24,  0, ANY_DIR, SILPH_CO_1F, 3
	warp_event 26,  0, ANY_DIR, SILPH_CO_3F, 1
	warp_event 20,  0, ANY_DIR, SILPH_CO_ELEVATOR, 1
	warp_event  3,  3, ANY_DIR, SILPH_CO_3F, 7
	warp_event 13,  3, ANY_DIR, SILPH_CO_8F, 5
	warp_event 27, 15, ANY_DIR, SILPH_CO_8F, 6
	warp_event  9, 15, ANY_DIR, SILPH_CO_6F, 5
