...
VictoryRoad3F_Object:
	...
	def_warp_events
	warp_event 23,  7, ANY_DIR, VICTORY_ROAD_2F, 4
	warp_event 26,  8, ANY_DIR, VICTORY_ROAD_2F, 6
	warp_event 27, 15, ANY_DIR, VICTORY_ROAD_2F, 5
	warp_event  2,  0, ANY_DIR, VICTORY_ROAD_2F, 7
