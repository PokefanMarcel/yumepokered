...
Route23_Object:
	...
	def_warp_events
	warp_event  7, 139, WARP_DOWN,  ROUTE_22_GATE, 3
	warp_event  8, 139, WARP_DOWN,  ROUTE_22_GATE, 4
	warp_event  4,  31, ANY_DIR,    VICTORY_ROAD_1F, 1
	warp_event 14,  31, ANY_DIR,    VICTORY_ROAD_2F, 2
