...
Route10_Object:
	...
	def_warp_events
	warp_event 11, 19, ANY_DIR,    ROCK_TUNNEL_POKECENTER, 1
	warp_event  8, 17, ANY_DIR,    ROCK_TUNNEL_1F, 1
	warp_event  8, 53, ANY_DIR,    ROCK_TUNNEL_1F, 3
	warp_event  6, 39, ANY_DIR,    POWER_PLANT, 1
	warp_event  3, 37, WARP_RIGHT, POWER_PLANT, 3 ; marcelnote - new western entrance
