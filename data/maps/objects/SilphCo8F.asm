...
SilphCo8F_Object:
	...
	def_warp_events
	warp_event 16,  0, ANY_DIR, SILPH_CO_9F, 2
	warp_event 14,  0, ANY_DIR, SILPH_CO_7F, 1
	warp_event 18,  0, ANY_DIR, SILPH_CO_ELEVATOR, 1
	warp_event  3, 11, ANY_DIR, SILPH_CO_8F, 7
	warp_event  3, 15, ANY_DIR, SILPH_CO_2F, 5
	warp_event 11,  5, ANY_DIR, SILPH_CO_2F, 6
	warp_event 11,  9, ANY_DIR, SILPH_CO_8F, 4
