...
SafariZoneNorth_Object:
	...
	def_warp_events
	warp_event  2, 35, WARP_DOWN,  SAFARI_ZONE_WEST, 1
	warp_event  3, 35, WARP_DOWN,  SAFARI_ZONE_WEST, 2
	warp_event  8, 35, WARP_DOWN,  SAFARI_ZONE_WEST, 3
	warp_event  9, 35, WARP_DOWN,  SAFARI_ZONE_WEST, 4
	warp_event 20, 35, WARP_DOWN,  SAFARI_ZONE_CENTER, 5
	warp_event 21, 35, WARP_DOWN,  SAFARI_ZONE_CENTER, 6
	warp_event 39, 30, WARP_RIGHT, SAFARI_ZONE_EAST, 1
	warp_event 39, 31, WARP_RIGHT, SAFARI_ZONE_EAST, 2
	warp_event 35,  3, ANY_DIR,    SAFARI_ZONE_NORTH_REST_HOUSE, 1
