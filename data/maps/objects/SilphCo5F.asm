...
SilphCo5F_Object:
	...
	def_warp_events
	warp_event 24,  0, ANY_DIR, SILPH_CO_6F, 2
	warp_event 26,  0, ANY_DIR, SILPH_CO_4F, 2
	warp_event 20,  0, ANY_DIR, SILPH_CO_ELEVATOR, 1
	warp_event 27,  3, ANY_DIR, SILPH_CO_7F, 6
	warp_event  9, 15, ANY_DIR, SILPH_CO_9F, 5
	warp_event 11,  5, ANY_DIR, SILPH_CO_3F, 5
	warp_event  3, 15, ANY_DIR, SILPH_CO_3F, 6
