...
ChampionsRoom_Object:
	...
	def_warp_events
	warp_event  3,  7, WARP_DOWN, LANCES_ROOM, 2
	warp_event  4,  7, WARP_DOWN, LANCES_ROOM, 3
	warp_event  3,  0, WARP_UP,   HALL_OF_FAME, 1
	warp_event  4,  0, WARP_UP,   HALL_OF_FAME, 1
