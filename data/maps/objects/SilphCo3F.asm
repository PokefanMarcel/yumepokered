...
SilphCo3F_Object:
	...
	def_warp_events
	warp_event 26,  0, ANY_DIR, SILPH_CO_2F, 2
	warp_event 24,  0, ANY_DIR, SILPH_CO_4F, 1
	warp_event 20,  0, ANY_DIR, SILPH_CO_ELEVATOR, 1
	warp_event 23, 11, ANY_DIR, SILPH_CO_3F, 10
	warp_event  3,  3, ANY_DIR, SILPH_CO_5F, 6
	warp_event  3, 15, ANY_DIR, SILPH_CO_5F, 7
	warp_event 27,  3, ANY_DIR, SILPH_CO_2F, 4
	warp_event  3, 11, ANY_DIR, SILPH_CO_9F, 4
	warp_event 11, 11, ANY_DIR, SILPH_CO_7F, 5
	warp_event 27, 15, ANY_DIR, SILPH_CO_3F, 4
