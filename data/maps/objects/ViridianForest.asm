	...
	const_export VIRIDIANFOREST_YOUNGSTER6 ; marcelnote - new trainer based on Samurai
...
ViridianForest_Object:
	...
	object_event 19,  3, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER6, OPP_BUG_CATCHER, 15 ; marcelnote - new trainer based on Samurai
