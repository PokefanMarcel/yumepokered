...
VermilionPokecenterMart_Object:
	...
	; Mart
	warp_event 19,  7, WARP_DOWN, LAST_MAP, 3
	warp_event 20,  7, WARP_DOWN, LAST_MAP, 3
	...
	object_event  7,  6, SPRITE_FISHING_GURU, STAY, RIGHT, TEXT_VERMILIONPOKECENTER_FISHING_GURU
