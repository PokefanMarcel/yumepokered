	...
	const_export VERMILIONGYM_LT_SURGE_REMATCH ; marcelnote - Lt.Surge rematch
...
VermilionGym_Object:
	...
	def_warp_events
	warp_event  4, 17, WARP_DOWN, LAST_MAP, 4
	warp_event  5, 17, WARP_DOWN, LAST_MAP, 4

	def_bg_events

	def_object_events
	object_event  5,  1, SPRITE_LT_SURGE, STAY, DOWN, TEXT_VERMILIONGYM_LT_SURGE, OPP_LT_SURGE, 1
	object_event  5,  1, SPRITE_LT_SURGE, STAY, DOWN, TEXT_VERMILIONGYM_LT_SURGE_REMATCH, OPP_LT_SURGE, 2 ; marcelnote - Lt.Surge rematch
