; marcelnote - this file is adapted from the one pokeyellow
;              in order to load new spritesets when entering a map
...
; Pikachu sprite reserves the second slot) is the VRAM tile pattern slot.
	...
	xor a
	call FillMemory
	ld a, SPRITE_BLUE ; load Pikachu separately
	ld [wSpriteSet], a
...
; Else, returns carry if the sprite uses 4 tiles
	cp SPRITE_BLUE       ; is this the Pikachu Sprite?
	ret z                   ; return if yes
