...
; entries correspond to item ids
	...
	dw UnusableItem      ; CITRUS_PASS ; marcelnote - new, was ITEM_2C
...
.notOldManBattle ; marcelnote - modified to handle more uncatchable scripted encounters
...
;ItemUseCardKey: ; marcelnote - removed
;	xor a
