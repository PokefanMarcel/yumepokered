DrawPartyMenu_::
	...
	call ClearScreen
	call UpdateSprites
	callfar LoadMonPartySpriteGfxWithLCDDisabled ; load pokemon icon graphics
...
RedrawPartyMenu_::
	...
	callfar InitPartyMenuBlkPacket
	hlcoord 3, 0
	ld de, wPartySpecies
	xor a
	ld c, a
...
.loop
	...
	callfar WriteMonPartySpriteOAMByPartyIndex ; place the appropriate pokemon icon
